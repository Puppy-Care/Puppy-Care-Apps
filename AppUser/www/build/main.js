...
var HomePage = (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-home",template:/*ion-inline-start:"/Users/vanessitaf8/Documents/GitHub/Puppy-Care-Apps/AppUser/src/pages/home/home.html"*/'<!--<div id="custom-overlay" [style.display]="splash ? \'flex\': \'none\'">\n  <div class="flb">\n    <div class="Aligner-item Aligner-item--top"></div>\n    <img src="assets/imgs/portada.png">\n    <div class="Aligner-item Aligner-item--bottom"></div>\n  </div>\n</div>-->\n\n<!-- ESTO VA EN ANDROID-->\n<ion-content>\n\n\n  <br><br><br><br>\n  <div class="Aligner-item Aligner-item--top"></div>\n  <img id="imganeTitulo" src="assets/imgs/titulo.png" style=" width: 30vh;margin-top: -5%">\n  <div class="Aligner-item Aligner-item--bottom"></div>\n  <br>\n\n  <form #Formulario="ngForm" (ngSubmit)="onSubmit()">\n    <div id="formLogin">\n      <div style="top:0; bottom: 0;" class="item item-block">\n        <ion-icon item-left style="  max-width:0.02%; margin-top:0%; margin-bottom:0; margin-right:5% ">\n          <img style=" max-width:90%;left: 0;right: 0; " src="assets/imgs/Recurso3.png">\n        </ion-icon>\n        <input type="email" #email="ngModel" [(ngModel)]="obj.email" name="email" class="form-control"\n          style="font-size:110%">\n      </div>\n      <br>\n      <div style="top:0; bottom: 0; " class="item item-block">\n        <ion-icon item-left style="  max-width:0.02%; margin-top:0%; margin-bottom:0; margin-right:5% ">\n          <img style=" max-width:90%;left: 0;right: 0; " src="assets/imgs/Recurso2.png">\n        </ion-icon>\n        <input [type]="getType()" #password="ngModel" [(ngModel)]="obj.password" name="password" class="form-control"\n          style="font-size:110%">\n      </div>\n      <br>\n      <!-- prueba de mostra contrase -->\n      <div class="checkbox" style="margin-left:10%">\n        <label>\n          <input type="checkbox" (click)="toggleTextPassword()"> Mostrar Contraseña</label>\n      </div>\n      <br>\n      <input type="submit" value="Ingresar"\n        style="background-color: #D79357; padding-top:2%; padding-bottom:2%; font-size: 100%; font-weight: bold; justify-content: center;"\n        class="form-control">\n\n        <ion-item *ngIf="this.error">\n          <ion-icon name="alert" item-start color="danger"></ion-icon>\n          <p ion-text color="danger">{{this.error}}</p>\n          \n        </ion-item>\n  \n  \n\n \n    <!-- <input type="submit" src="assets/imgs/btnFaceboock.png" type="image" style="left:0; right:0;max-width:100%;  "> -->\n    <button (click)="onCLick()" style="background: transparent; border: none; font-size: 110%; font-weight: bold "\n      class="form-control">\n      Registrarse\n    </button>\n    <br>\n    <button (click)="onCLickTerminos()"\n      style="background: transparent; border: none; font-size: 110%; font-weight: bold " class="form-control">\n      Términos y condiciones\n    </button>\n    <br>\n\n  </div>\n    \n</form>  \n</ion-content>'/*ion-inline-end:"/Users/vanessitaf8/Documents/GitHub/Puppy-Care-Apps/AppUser/src/pages/home/home.html"*/,
